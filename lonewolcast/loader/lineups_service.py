...
class LineupService:
    ...
    def fetch_lineups(self, fixture_id):
        ...
        try:
            ...
            if lineups:
                print(f"✅ Compositions récupérées")
                return lineups
            
            print("ℹ️ Pas de compositions disponibles")
            return None
    ...
    def clear_lineups(self, matches=None):
        """Supprime les compositions des matchs spécifiés ou tous les matchs."""
        try:
            if not matches:
